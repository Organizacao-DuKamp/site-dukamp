...
function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-muted/30">
      <aside className="w-60 bg-sidebar border-r flex flex-col">
        <Link to="/admin" className="flex items-center gap-2 px-4 h-16 border-b">
        ...
        <div className="p-2 border-t space-y-1">
          ...
          <button onClick={() => signOut()} className="w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm hover:bg-accent">
