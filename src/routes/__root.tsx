...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dukamp Saúde Animal" },
      { name: "description", content: "E-commerce Dukamp Saúde Animal — produtos veterinários para cães, gatos e bovinos." },
      { property: "og:title", content: "Dukamp Saúde Animal" },
      { property: "og:description", content: "E-commerce Dukamp Saúde Animal — produtos veterinários para cães, gatos e bovinos." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Dukamp Saúde Animal" },
      { name: "twitter:description", content: "E-commerce Dukamp Saúde Animal — produtos veterinários para cães, gatos e bovinos." },
